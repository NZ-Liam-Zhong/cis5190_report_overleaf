...
\begin{document}
\head{Spring 2026}{Reading Between the Headlines: Detecting News Source Style with DeBERTa-V3}{Haoran Wu, Ningze Zhong, Yuzhou Shen \quad Group: ZSL}{Project B: News Source Classification}
...
\begin{subfigure}{0.31\linewidth}
  \centering\includegraphics[width=\linewidth]{figures/confusion_matrix.png}
  \caption{Confusion matrix.}
\end{subfigure}\hfill
\begin{subfigure}{0.34\linewidth}
  \centering\includegraphics[width=\linewidth]{figures/calibration.png}
  \caption{Reliability diagram + confidence histogram (ECE $=0.127$).}
\end{subfigure}\hfill
\begin{subfigure}{0.31\linewidth}
  \centering\includegraphics[width=\linewidth]{figures/latency.png}
...
We thank the CIS 5190 staff for the project resources, the Hugging Face team for the model and dataset hubs, and the Hugging Face Mirror service which kept the network round-trip from our compute environment workable.
